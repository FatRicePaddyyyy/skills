...
```bash
gh skill install FatRicePaddyyyy/skills user-context
gh skill install FatRicePaddyyyy/skills verbalize
gh skill install FatRicePaddyyyy/skills structure-first
```
