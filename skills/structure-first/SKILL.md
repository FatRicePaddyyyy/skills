...
description: >-
  文章を作成するときに使う。本文を書く前に、必ずワンステップで構造（骨組み）を先に決め、
  ユーザーに確認してから書く。メッセージ・主張・依頼・報告・説明・Slack/メール・PR 文など、
  文章・原稿・文面の新規作成や書き換えのたびに使う。
  Use whenever creating or rewriting prose — 文章を書いて, 文面を作って, メッセージ作成,
  drafting, 構成, 構造, 骨組み, アウトライン, 先に型, 順番を決めて.
---
